...
def sync_detailed(
    ...
    *,
    ...
    """Deletes an existing Charge Point based on the chargeBoxPk.
    Returns the deleted Charge Point.
    This is a very destructive operation:
    Deleting a charge point causes losing all related information including transactions, reservations,
    connector status and connector meter values.
