...
T = TypeVar("T", bound="PermissionDtoForTag")


@_attrs_define
class PermissionDtoForTag:
    """
    Attributes:
        ocpp_tag_pk (int | Unset): PK of Ocpp Tag with the associated permissions
        permissions (list[NodeEntry] | Unset): List of permissions for the Ocpp Tag
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permission_dto_for_tag = cls(
            ocpp_tag_pk=ocpp_tag_pk,
            permissions=permissions,
        )

        permission_dto_for_tag.additional_properties = d
        return permission_dto_for_tag
