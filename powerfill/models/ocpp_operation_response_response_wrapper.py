...
if TYPE_CHECKING:
    ...
    from ..models.success_response_response_wrapper import SuccessResponseResponseWrapper


T = TypeVar("T", bound="OcppOperationResponseResponseWrapper")


@_attrs_define
class OcppOperationResponseResponseWrapper:
    """
    Attributes:
        error_responses (list[ErrorResponse] | Unset):
        exceptions (list[CallException] | Unset):
        success_responses (list[SuccessResponseResponseWrapper] | Unset):
    ...
    success_responses: list[SuccessResponseResponseWrapper] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _success_responses is not UNSET:
            ...
            for success_responses_item_data in _success_responses:
                success_responses_item = SuccessResponseResponseWrapper.from_dict(success_responses_item_data)
        ...
        ocpp_operation_response_response_wrapper = cls(
        ...
        ocpp_operation_response_response_wrapper.additional_properties = d
        return ocpp_operation_response_response_wrapper
