...
T = TypeVar("T", bound="CancelReservationParams")
...
class CancelReservationParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_reservation_params = cls(
            charge_box_id_list=charge_box_id_list,
            reservation_id=reservation_id,
        )

        cancel_reservation_params.additional_properties = d
        return cancel_reservation_params
