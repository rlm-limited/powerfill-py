...
if TYPE_CHECKING:
    ...
    from ..models.success_response_string import SuccessResponseString


T = TypeVar("T", bound="OcppOperationResponseString")


@_attrs_define
class OcppOperationResponseString:
    """
    Attributes:
        error_responses (list[ErrorResponse] | Unset):
        exceptions (list[CallException] | Unset):
        success_responses (list[SuccessResponseString] | Unset):
    ...
    success_responses: list[SuccessResponseString] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _success_responses is not UNSET:
            ...
            for success_responses_item_data in _success_responses:
                success_responses_item = SuccessResponseString.from_dict(success_responses_item_data)
        ...
        ocpp_operation_response_string = cls(
        ...
        ocpp_operation_response_string.additional_properties = d
        return ocpp_operation_response_string
