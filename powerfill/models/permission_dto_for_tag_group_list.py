...
T = TypeVar("T", bound="PermissionDtoForTagGroupList")


@_attrs_define
class PermissionDtoForTagGroupList:
    """
    Attributes:
        ocpp_tag_groups (list[PermissionDtoForTagGroup] | Unset):
    """

    ocpp_tag_groups: list[PermissionDtoForTagGroup] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ocpp_tag_groups is not UNSET:
            ...
            for ocpp_tag_groups_item_data in _ocpp_tag_groups:
                ocpp_tag_groups_item = PermissionDtoForTagGroup.from_dict(ocpp_tag_groups_item_data)

                ocpp_tag_groups.append(ocpp_tag_groups_item)

        permission_dto_for_tag_group_list = cls(
            ocpp_tag_groups=ocpp_tag_groups,
        )

        permission_dto_for_tag_group_list.additional_properties = d
        return permission_dto_for_tag_group_list
