...
T = TypeVar("T", bound="UnlockConnectorParams")


@_attrs_define
class UnlockConnectorParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unlock_connector_params = cls(
            charge_box_id_list=charge_box_id_list,
            connector_id=connector_id,
        )

        unlock_connector_params.additional_properties = d
        return unlock_connector_params
